...
class _DraggableSwimmingPositionedState extends State<DraggableSwimmingPositioned> {
  double x,y;
  ...
  void didChangeDependencies() {
    ...
    widget.arrangeStream.listen((e) {
      ...
      if(e) {
        x = widget.x;
        y = widget.y;
        velocityPolar = PolarCoordinates(velocityPolar.r * 0.1, velocityPolar.theta);
      }
    });
