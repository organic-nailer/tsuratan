...
class TsuratanState with _$TsuratanState {
  const factory TsuratanState({
    @Default(true) bool startVisible,
    @Default(0) int score,
    @Default(0) int tanni,
    @Default(0) int oneClicked,
    @Default(0) int tenClicked,
    @Default(0) int hunClicked,
    @Default(0) int thoClicked,
    @Default([]) List<FloatingTsuratan> tsuratanium,
    @Default([]) List<FallingCredit> rakutanium,
  }) = _TsuratanState;
}
